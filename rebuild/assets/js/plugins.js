...
(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    // Carousel Options
    itemWidth: 1100,                   //{NEW} Integer: Box-model width of individual carousel items, including horizontal borders and padding.
    ...
    // Callback API
    start: function(e){
							$(".slider-caption")[0].innerHTML =  e.slides[e.currentSlide].children[0].children[0].getAttribute('data-caption'); 
